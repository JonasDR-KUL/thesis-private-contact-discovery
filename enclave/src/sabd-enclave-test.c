...
{
    /* Jo: quick hack to only print first 100 accesses, otherwise the printing
     * causes too much delay and the tests take ages to comlete ^^ */
    static int print_count = 0;
    if (print_count++ < 100)
    {
        print_message("\t[sgxsabd-enclave-test] Enclave says: %p\n", pt);
    }
}
