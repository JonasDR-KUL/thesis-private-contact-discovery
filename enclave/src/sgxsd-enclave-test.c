...
/* Jo: just here for completeness, in case you'd use the ocall_print function in
 * the file sgxsd-enclave.c as well */
void sgxsd_ocall_print_pt(void* pt)
{
    print_message("\t[sgxsd-enclave-test] Enclave says: %p\n", pt);
}
