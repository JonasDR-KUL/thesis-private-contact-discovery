...
sgx_status_t sgxsd_enclave_generate_curve25519_privkey(sgxsd_curve25519_private_key_t *p_privkey) {
...
sgx_status_t sgxsd_enclave_generate_curve25519_keypair(sgxsd_curve25519_key_pair_t *p_keypair) {
    ...
    sgx_status_t gen_privkey_res = sgxsd_enclave_generate_curve25519_privkey(&p_keypair->privkey);
...
sgx_status_t sgxsd_enclave_add_pending_request(sgxsd_pending_request_id_t *p_pending_request_id, const sgxsd_pending_request_t *p_pending_request) {
    ...
    g_sgxsd_enclave_pending_requests[pending_request_id_val & pending_request_count_mask] = (sgxsd_pending_request_t) {
        .id_val   = pending_request_id_val,
        .hkdf_prk = p_pending_request->hkdf_prk,
    };
